...
export const Experience = () => {
  ...
  useControls({
    'Restart': button(() => tl.current.restart()),
  })
  ...
  useLayoutEffect(() => {
    ...
    tl.current.to(car.current.position, { duration: 2, y: -1.18 })
    tl.current.to(podium.current.position, { duration: 2, y: -1.35 }, 0)
    tl.current.to(car.current.rotation, {
      duration: 2,
      y: Math.PI * 2 - Math.PI / 6,
    }, 0)
    tl.current.to(podium.current.rotation, { duration: 1, y: Math.PI * 12 })
    tl.current.to(podium.current.position, { duration: 0.5, z: -8 }, 1.5)
    tl.current.to(podium.current.rotation, { duration: 1, x: Math.PI / 4 }, 1.8)
  }, [])
